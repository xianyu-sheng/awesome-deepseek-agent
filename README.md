...
| **Xenon** | Open-source terminal AI coding agent with 8 reasoning engines, DeepSeek cache optimization, MCP protocol, and Smithery integration. | [Guide](./docs/xenon.md) |
