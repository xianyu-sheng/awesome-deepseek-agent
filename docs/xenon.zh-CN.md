...
安装 Python 3.10 或更高版本，然后安装已验证的 v0.7.0 版本：
...
Xenon v0.7.0 提供会话、项目本地、项目共享和用户全局四个隔离的记忆作用域。
...
存储和授权模型详见[记忆系统规范](https://github.com/xianyu-sheng/Xenon/blob/v0.7.0/docs/MEMORY_SYSTEM_SPEC.md)。
