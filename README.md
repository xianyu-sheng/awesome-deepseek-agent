...
| **OmniAgent** | Open-source multi-model AI agent scheduling engine with 8 inference paradigms, 20+ tools, MCP + Smithery library, and engineering reliability layers. | [Guide](./docs/omniagent.md) |
