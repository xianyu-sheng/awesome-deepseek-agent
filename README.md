...
| **Xenon** | Open-source terminal AI coding agent with 8 reasoning engines, DeepSeek cache optimization + Vision Bridge (multimodal via model pool), MCP protocol, and Smithery integration. | [Guide](./docs/xenon.md) |
